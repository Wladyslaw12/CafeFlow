            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Бронь</h6>
                    </div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Клиент : {{$item->client()->first()->name . ' (' . $item->client()->first()->phone . ')'}}</li>
                            <li class="list-group-item">Столик : {{$item->table()->first()->title}}</li>
                            <li class="list-group-item">Дата и время : {{\Carbon\Carbon::parse($item['reservation_date'])->format('d.m.Y H:i')}}</li>
                        </ul>
                        <div class="mt-4">
