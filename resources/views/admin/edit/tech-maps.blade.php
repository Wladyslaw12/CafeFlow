...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('tech-maps.update', ['id' => $item->id]) }}">
                            @csrf
                            @method('PATCH')
                            ...
                            <table class="table table-bordered" id="products-table">
                                ...
                                <tbody>
                                @foreach($item->technicalMapProducts as $index => $itemProduct)
                                    <tr>
                                        <td>
                            ...
                            <a href="{{ route('tech-maps.index') }}" class="btn btn-secondary">Отмена</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <table style="display: none;">
        ...
        <tr id="product-row-template">
            ...
            <td>
                <input type="number" inputmode="decimal" name="products[__INDEX__][count]" class="form-control" min="0.01" step="0.01" required>
            </td>
            <td>
                <button type="button" class="btn btn-danger remove-product-btn">
                    <i class="fas fa-trash"></i>
