...
<head>
    ...
    <style>
        ...
        .icon-input i.fa-envelope {
            ...
            color: #667eea;
            z-index: 2; /* Добавляем z-index для иконок слева */
        }

        .input-icon {
            padding-left: 45px !important;
            padding-right: 45px !important; /* Добавляем отступ справа */
        }
        ...
        .password-toggle {
            ...
            cursor: pointer;
            color: #667eea;
            z-index: 2; /* Добавляем z-index для иконки справа */
            background: rgba(255,255,255,0.5); /* Фон для перекрытия текста */
            padding: 0 5px;
            border-radius: 3px;
        }
