...
class TechMapRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            'title' => ['required','string', 'between:1,255', Rule::unique('technical_maps', 'title')],
    ...
    {
        return [
            'unique' => 'Тех карта с таким именем уже существует',
